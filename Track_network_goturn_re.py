...
model_name = 'model64_4l_2017-11-190954_re4'
...
# with tf.Session(config=tf.ConfigProto(log_device_placement=True)) as sess:
    ...
    while num_batches < kNumBatches:
        ...
        print 'logits_out[30]',logits_out[30]
        print "batch_y[30]", batch_y_curr[30]
        print 'logits_out[60]',logits_out[60]
        print "batch_y[60]", batch_y_curr[60]
        print 'logits_out[90]',logits_out[90]
        print "batch_y[90]", batch_y_curr[90]
        ...
        if num_batches % 1000 == 0:
            ...
            save_path = saver.save(sess, "./tmp/" + model_name + "_re5.ckpt")
